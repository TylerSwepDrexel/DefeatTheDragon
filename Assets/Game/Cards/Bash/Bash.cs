    ...
    public override void OnMouseUp()
    {
        ...
        else
        {
            ...
            if (playerMana >= processedManaCost)
            {
                ...
                interjectionEvent.Raise(new CallForInterjections(this.gameObject, target, InteractionType.Vulnerable, vulnerabilityProcessor.GetComponent<InterjectionProcessor>()));
